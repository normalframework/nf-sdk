...
goog.exportSymbol('proto.normalgw.bacnet.AbortReason', null, global);
goog.exportSymbol('proto.normalgw.bacnet.DeviceIds', null, global);
goog.exportSymbol('proto.normalgw.bacnet.EngineeringUnits', null, global);
goog.exportSymbol('proto.normalgw.bacnet.ErrorClass', null, global);
goog.exportSymbol('proto.normalgw.bacnet.ErrorCode', null, global);
goog.exportSymbol('proto.normalgw.bacnet.ObjectType', null, global);
goog.exportSymbol('proto.normalgw.bacnet.PropertyId', null, global);
goog.exportSymbol('proto.normalgw.bacnet.RejectReason', null, global);
/**
 * @enum {number}
 */
proto.normalgw.bacnet.DeviceIds = {
 ...
 * @enum {number}
 */
proto.normalgw.bacnet.ErrorClass = {
 ...
 * @enum {number}
 */
proto.normalgw.bacnet.AbortReason = {
 ...
 * @enum {number}
 */
proto.normalgw.bacnet.RejectReason = {
 ...
 * @enum {number}
 */
proto.normalgw.bacnet.ErrorCode = {
  ERROR_CODE_OTHER: 0,
 ...
 * @enum {number}
 */
proto.normalgw.bacnet.ObjectType = {
 ...
 * @enum {number}
 */
proto.normalgw.bacnet.PropertyId = {
 ...
 * @enum {number}
 */
proto.normalgw.bacnet.EngineeringUnits = {
